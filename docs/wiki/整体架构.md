...
flowchart LR
  ...
  subgraph Storage["本地持久化"]
    ...
    ExperimentalReports["experimental/personality_profile.json<br/>experimental/prompt_context.md"]
  ...
  RelationshipAnalysis --> ExperimentalReports
  ProactiveAnalysis --> ProactiveReport
  Retrieve --> Lance
  Relationship --> Lance
  Prompt --> Persona
  AnalysisReports -. "按独立开关注入人格 / Life；时间线仅展示" .-> Prompt
  ExperimentalReports -. "双开关启用后注入实验人格上下文" .-> Prompt
